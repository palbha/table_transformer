This Repository showcase how we can run a table structure detection and tabel identification model using Table transformer & streamlit in python on Google colab .
